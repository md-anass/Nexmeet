...
type MeetingStageProps = { localParticipant: LocalParticipant; remoteParticipants: Participant[]; cameraTracks: TrackReference[]; screenShareTrack?: TrackReference; displayName: string; cameraEnabled: boolean; microphoneEnabled: boolean; currentHostParticipantKey: string | null };

export function MeetingStage({ localParticipant, remoteParticipants, cameraTracks, screenShareTrack, displayName, cameraEnabled, microphoneEnabled, currentHostParticipantKey }: MeetingStageProps) {
